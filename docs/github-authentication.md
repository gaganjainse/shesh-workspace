---
title: github_auth.py + git_askpass.py
type: how-to
...
- The fleet CI checkouts pass `persist-credentials: false` so runner-side
  tokens are not written to disk either (see [SECURITY](https://github.com/gaganjainse/shesh-docs/blob/main/src/governance/security-policy.md)).
